...
class LinkedListTests: XCTestCase {
    ...
    func testInsertListAtIndex() {
        ...
        XCTAssertEqual(list.nodeAt(1)?.value, 2)
        XCTAssertEqual(list.nodeAt(2)?.value, 99)
        XCTAssertEqual(list.nodeAt(3)?.value, 102)
        XCTAssertEqual(list.nodeAt(4)?.value, 10)
    }
    ...
    func testInsertListAtFirstIndex() {
        ...
        XCTAssertTrue(list.count == 8)
        XCTAssertEqual(list.nodeAt(0)?.value, 99)
        XCTAssertEqual(list.nodeAt(1)?.value, 102)
        XCTAssertEqual(list.nodeAt(2)?.value, 8)
    }
    ...
    func testInsertListAtLastIndex() {
        ...
        XCTAssertTrue(list.count == 8)
        XCTAssertEqual(list.nodeAt(5)?.value, 5)
        XCTAssertEqual(list.nodeAt(6)?.value, 99)
        XCTAssertEqual(list.nodeAt(7)?.value, 102)
    }
    ...
    func testAppendListToEmptyList() {
        ...
        XCTAssertEqual(list.nodeAt(0)?.value, 5)
        XCTAssertEqual(list.nodeAt(1)?.value, 10)
    }
